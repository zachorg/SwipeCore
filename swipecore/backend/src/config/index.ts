...
export const config = {
  ...
  authRefreshTtlSeconds: Number(process.env.AUTH_REFRESH_TTL_SECONDS) || (60 * 60 * 24 * 30), // 30 days
  authAccessTtlSeconds: Number(process.env.AUTH_ACCESS_TTL_SECONDS) || (60 * 10), // 30 days
};
