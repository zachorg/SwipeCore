...
with_node \
  ...
  --target "/Users/nidhipatel/Desktop/Vrij/repo/SwipeCore/swipecore/ios/Pods/Target Support Files/Pods-NomNom/ExpoModulesProvider.swift" \
  --entitlement "/Users/nidhipatel/Desktop/Vrij/repo/SwipeCore/swipecore/ios/NomNom/NomNom.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-location" "expo-router" "expo-secure-store" "expo-speech" "expo-speech-recognition" "expo-web-browser"
